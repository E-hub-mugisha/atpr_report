...
<div class="nk-split nk-split-page nk-split-lg">
    <div class="nk-split-content nk-block-area nk-block-area-column nk-auth-container bg-white">
        ...
        <div class="nk-block nk-block-middle nk-auth-body">
            ...
            <form method="POST" action="{{ route('password.email') }}">
                ...
                <div class="form-group">
                    ...
                    <div class="form-control-wrap">
                        <input autocomplete="username" type="text" name="email" class="form-control form-control-lg" required id="email" placeholder="Enter your email address">
                    </div>
                </div>
            ...
            <div class="form-note-s2 pt-4"> Remembered your password? <a href="{{ route('login') }}">Sign in
