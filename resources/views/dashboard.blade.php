                                    ...
                                    <div class="card-inner">
                                        <div class="card-title-group align-start mb-2">
                                            <div class="card-title">
                                                ...
                                                <p>In last 30 days students enrolled.</p>
                                            </div>
                                        ...
                                        <div
                                            ...
                                            <div class="nk-sale-data-group flex-md-nowrap g-4">
                                                <div class="nk-sale-data"><span
                                                        class="amount">{{ $totalStudentsMonth }} </span><span
                                                        class="sub-title">This Month</span></div>
                                                <div class="nk-sale-data"><span
                                                        class="amount">{{ $totalStudentsWeek }} </span><span
                                        ...
                                        <div class="card card-bordered">
                                            <div class="card-inner">
                                                ...
                                                <div
                                                    ...
                                                    <div class="nk-sale-data"><span
                                                            class="amount">{{ $activeStudents }}</span>
                                    ...
                                    <div class="col-sm-6 col-lg-12 col-xxl-6">
                                        <div class="card card-bordered">
                                            <div class="card-inner">
                                                <div class="card-title-group align-start mb-2">
                                                    <div class="card-title">
                                                        <h6 class="title">Avg Students</h6>
                                                    </div>
                                                    <div class="card-tools"><em
                                                            class="card-hint icon ni ni-help-fill"
                                                            data-bs-toggle="tooltip"
                                                ...
                                                <div
                                                    class="align-end flex-sm-wrap g-4 flex-md-nowrap">
                                                    <div class="nk-sale-data"><span
                                                            class="amount"> {{ $avgStudents }} </span><span
                        ...
                        <div class="card card-bordered h-100">
                            <div class="card-inner">
                                <div class="card-title-group align-start gx-3 mb-3">
                                    <div class="card-title">
                                        <h6 class="title">Students Overview</h6>
                                        <p>In 30 days students of {{ $courseName }}. <a href="#">See
                                                Details</a></p>
                                    </div>
                                ...
                                <div
                                    ...
                                    <div class="nk-sale-data"><span class="amount">{{ $activeStudents }}</span>
                                    </div>
                                    <div class="nk-sale-data"><span class="amount sm">{{ $totalStudents }}</span>
                                            <small>enrolled</small></span></div>
                                </div>
                        ...
                        <div class="card card-bordered card-full">
                            <div class="card-inner">
                                <div class="card-title-group">
                                    <div class="card-title">
                                        <h6 class="title"><span class="me-2">Students</span> <a
                                    ...
                                    <div class="card-tools">
                                        <ul class="card-tools-nav">
                                            ...
                                            <li><a href="#"><span>Inactive</span></a></li>
                                            <li><a href="#"><span>Graduated</span></a></li>
                                            <li><a href="#"><span>Dropped</span></a></li>
                                            <li class="active"><a href="{{ route('students.index') }}"><span>All</span></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="card-inner p-0 border-top">
                                <div class="nk-tb-list nk-tb-orders">
                                    <div class="nk-tb-item nk-tb-head">
                                        <div class="nk-tb-col"><span>Student No.</span></div>
                                        <div class="nk-tb-col tb-col-sm"><span>Names</span></div>
                                        <div class="nk-tb-col tb-col-md"><span>Phone</span></div>
                                        <div class="nk-tb-col tb-col-lg"><span>Academic Year</span></div>
                                        <div class="nk-tb-col"><span>Intake</span></div>
                                    ...
                                    <div class="nk-tb-item">
                                        <div class="nk-tb-col"><span class="tb-lead"><a
                                                    href="#">#{{ $student->student_id }}</a></span></div>
                                        <div class="nk-tb-col tb-col-sm">
                                            <div class="user-card">
                                                <div class="user-avatar user-avatar-sm bg-purple">
                                                    <span>{{ substr($student->first_name, 0, 2) }}</span>
                                                </div>
                                                <div class="user-name"><span class="tb-lead">{{ $student->first_name }} {{ $student->last_name }}</span></div>
                                            </div>
                                        </div>
                                        <div class="nk-tb-col tb-col-md"><span
                                                class="tb-sub">{{ $student->phone }}</span></div>
                                        <div class="nk-tb-col tb-col-lg"><span
                                                class="tb-sub text-primary">{{ $student->academic_year }}</span></div>
                                        <div class="nk-tb-col"><span
                                                class="tb-sub tb-amount">{{ $student->intake_no }}/{{ $student->intake_year }}</span></div>
                                        <div class="nk-tb-col"><span
                                                class="badge badge-dot badge-dot-xs bg-success">{{ $student->status }}</span>
                                        </div>
                        ...
                        <div class="card card-bordered card-full">
                            <div class="card-inner-group">
                                ...
                                <div class="card-inner card-inner-md">
                                    <div class="user-card">
                                        <div class="user-avatar bg-primary-dim"><span>{{ $user->name[0] }}</span>
                                        </div>
