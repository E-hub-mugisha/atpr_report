...
class StudentInfoReport implements FromView, WithStyles, WithColumnWidths, ShouldAutoSize, WithTitle
{
    public $intake;
    ...
    {
        return view('reports.student_info_report', [
    ...
    /** Set sheet title safely (max 31 characters) */
    public function title(): string
    {
        $sheetTitle = 'Students Info ' . $this->intake;
